...
{{--            <x-application-logo class="block h-10 mr-3" />--}}
{{--            <img src="{{url('assets/logo/nav_bar_logo.png')}}" class="block h-10 mr-3">--}}
            <img src="{{url('assets/logo/logo_image_64.png')}}" class="block h-10 mr-3">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">{{__("nav.header")}}</span>
        </a>

        <div class="flex items-center align-items-center justify-items-center md:order-2">
            ...
            <button type="button" class="inline-flex items-center ml-2 py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                ...
                <div>
                    <x-admin-badge/> {{ $auth_user->username }}
                </div>
                <div class="ml-1">
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                <div class="px-4 py-3">
                    ...
                    <span class="block text-sm  text-gray-500 truncate dark:text-gray-400">{{ $auth_user->isAdmin() ? 'Admin':'User'  }}</span>
                </div>
                <ul class="py-2" aria-labelledby="user-menu-button">
                    ...
                    <li>
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Help</a>
                    </li>
                    <li>
...
{{--            </button>--}}
        ...
        {{--<div class="items-start justify-start hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="{{route('dashboard')}}" class="block py-2 pl-3 pr-4 text-black rounded md:bg-transparent md:p-0 md:dark:text-white" aria-current="page">Dashboard</a>
                </li>
                --}}{{--<li>
